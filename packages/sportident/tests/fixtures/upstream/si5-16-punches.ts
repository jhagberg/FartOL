...
// Specifically: the `getCardWith16Punches` export. cardData + storageData copied byte-for-byte.
...
export const fixture: SiCardSample & { name: string } = {
  ...
  cardData: {
    ...
    cardHolder: {
      countryCode: 0x29, // = 41 (byte 0x01)
      clubCode: 0x01, // SiInt[0x03, 0x02] little-endian bit-concat -> (0x00 << 8) | 0x01 = 1
    },
    softwareVersion: 0x28, // = 40 (byte 0x1B = 0x28; upstream NOTE in storageData line 2 column 12)
  },
  storageData: [
    ...unPrettyHex(`
