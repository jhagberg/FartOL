...
// `npm install -g fartol-*.tgz` don't need a separate publish step for
// @fartol/sportident or @fartol/shared-types. Everything else (fastify,
...
export default defineConfig({
  ...
  noExternal: ['@fartol/sportident', '@fartol/shared-types'],
  ...
  // the bin path `dist/bin/fartol.cjs`. Without this, esbuild leaves
