...
function ReadoutView({ t, density, currentRead, history, onSimulate, onPrint, onSelectRead, walkupOpen, setWalkupOpen, lastFlashKey, autoPrint, setAutoPrint, defaultTpl, setDefaultTpl }) {
    ...
    <div className="readout">
      ...
      <div className={"ro-main " + (isLow ? 'low-density' : '')}>
        ...
        {currentRead && currentRead.punches && (
          <div style={{padding: '14px 18px', borderTop: '1px solid var(--border)', display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap'}}>
    ...
    <div className="modal-scrim" onClick={onCancel}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{width: 'min(560px, 100%)'}}>
        ...
        <div className="modal-foot">
          ...
          <button className="btn primary" disabled={!valid} onClick={() => onSave({ name, club, cls, card })}
...
Object.assign(window, { ReadoutView, StatusPill, WalkupModal });
